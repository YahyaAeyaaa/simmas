...
export default function ModalEditDudi({ isOpen, onClose, onSubmit, dudiData }: ModalEditDudiProps) {
    ...
    useEffect(() => {
        if (dudiData && isOpen) {
            setFormData({
                namaPerusahaan: dudiData.namaPerusahaan || "",
                alamat: dudiData.alamat || "",
                telepon: dudiData.telepon || "",
                email: dudiData.email || "",
                penanggungJawab: dudiData.penanggungJawab || "",
    ...
    const validateForm = () => {
        ...
        if (formData.kuotaMagang <= 0) {
            newErrors.kuotaMagang = "Kuota magang harus lebih dari 0";
            isValid = false;
        }
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center backdrop-blur-sm bg-gray-900/30">
            ...
            <div className="relative bg-white rounded-lg shadow-xl w-full max-w-2xl mx-4 max-h-[90vh] overflow-y-auto">
                ...
                <div className="sticky top-0 bg-white flex items-center justify-between px-6 py-4 border-b border-gray-200 rounded-t-lg z-10">
                    <h3 className="text-lg font-semibold text-gray-900">Edit DUDI</h3>
                    <button
                        onClick={handleClose}
                        disabled={isLoading}
